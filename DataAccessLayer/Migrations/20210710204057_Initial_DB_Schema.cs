        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(nullable: true),
                    LastName = table.Column<string>(nullable: true),
                    AMKA = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cuts = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BurgId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiagnosticCenters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiagnosticCenters_Districts_BurgId",
                        column: x => x.BurgId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordType = table.Column<string>(maxLength: 128, nullable: false),
                    TestType = table.Column<string>(nullable: true),
                    Result = table.Column<bool>(nullable: true),
                    VaccineId = table.Column<short>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Records", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Records_DiagnosticCenters_DiagnosticCenterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiagnosticCenters_BurgId",
                table: "DiagnosticCenters",
                column: "BurgId");

            migrationBuilder.CreateIndex(
                name: "IX_DiagnosticCenters_Code",
                table: "DiagnosticCenters",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Persons_AMKA",
                table: "Persons",
                column: "AMKA",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Records_DiagnosticCenterId",
                table: "Records",
                column: "DiagnosticCenterId");
